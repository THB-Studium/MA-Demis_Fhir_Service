...
//        log.info("::: BinaryRootController.create() - create a BinaryMod :::");
//        BinaryMod created = service.create(newBinaryString, mediaType);
//        log.info("::: BinaryRootController.create() - BinaryMod created :::");
//        return created;
//    }
//
//    @Produces(MediaType.APPLICATION_JSON)
...
//        log.info("::: BinaryRootController.listAll() - fetch all :::");
//        List<BinaryMod> binaries = service.listAll();
//        log.info("::: BinaryRootController.listAll() - Binaries Resources fetched :::");
//        return binaries;
//    }
}
