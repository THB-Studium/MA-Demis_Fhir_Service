...
public class Resource extends BaseResource implements Serializable {
    ...
    @Child(
            name = "id",
            type = {org.hl7.fhir.r4.model.IdType.class},
            order = 0,
            summary = true
    )
    @Description(
    ...
    @Description(
            ...
            value = "A reference to a set of rules that were followed when the resource " +
                    "was constructed, and which must be understood when processing the content. " +
                    "Often, this is a reference to an implementation guide that defines the special " +
