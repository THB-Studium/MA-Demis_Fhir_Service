...
//        Join<Coding, UriType> binary2UriTypeJoin = root.join("meta").join("meta.tag").join("tag.system");
//
//        return builder.like(builder.lower(binary2UriTypeJoin.get("system.myStringValue")), criteria.getSystem().toLowerCase());
//    }
//
////    /*** criteria builder for: code ***/
////    private Predicate getCodePredicate(@NotNull Root<BinaryMod> root, @NotNull CriteriaBuilder builder) {
////        Join<Coding, CodeType> binary2CodeTypeJoin = root.join(BinaryMod_.meta).join(Meta_.tag).join(Coding_.code);
////
////        return builder.like(builder.lower(binary2CodeTypeJoin.get(UriType_.myStringValue)), criteria.getCode().toLowerCase());
////    }
////
...
////
////        return builder.like(builder.lower(binary2codingJoin.get(Coding_.display)), criteria.getDisplay().toLowerCase());
////    }
////
...
////            case AP, EQ -> {
////                return builder.equal(metaJoin.get(Meta_.lastUpdated), criteria.getLastUpdated());
////            }
////            case EB, LT -> {
////                return builder.lessThan(metaJoin.get(Meta_.lastUpdated), criteria.getLastUpdated());
////            }
////            case GE -> {
////                return builder.greaterThanOrEqualTo(metaJoin.get(Meta_.lastUpdated), criteria.getLastUpdated());
////            }
////            case GT, SA -> {
////                return builder.greaterThan(metaJoin.get(Meta_.lastUpdated), criteria.getLastUpdated());
////            }
////            case LE -> {
////                return builder.lessThanOrEqualTo(metaJoin.get(Meta_.lastUpdated), criteria.getLastUpdated());
////            }
////            case NE -> {
////                return builder.notEqual(metaJoin.get(Meta_.lastUpdated), criteria.getLastUpdated());
////            }
////            default ->
////                    throw new ResourceNotFoundException(String.format("::: Search date operation '%s' not allowed! :::", criteria.getSearchDateOp()));
////        }
////    }
//
//
